...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		private float _animationForwardSpeed;
		...
		{
			_animIDForwardSpeed = Animator.StringToHash("StrafingZ");
			_animIDLeftRight = Animator.StringToHash("StrafingX");
		...
		private void Move()
		{
			...
			targetSpeed = _input.aim ? MoveSpeed : targetSpeed;
			...
			_animationForwardSpeed = Mathf.Lerp(_animationForwardSpeed, targetSpeed, Time.deltaTime * SpeedChangeRate);
			//_animationLeftRightSpeed = Mathf.Lerp(_animationLeftRightSpeed, _input.move.x, Time.deltaTime);
			...
			if (_hasAnimator)
			{
                ...
                {
					_input.sprint = false;
					_animator.SetFloat(_animIDForwardSpeed, _input.move.y * 2);
					_animator.SetFloat(_animIDLeftRight, _input.move.x * 2);
				}
                else
                {
					_animator.SetFloat(_animIDForwardSpeed, _animationForwardSpeed);
